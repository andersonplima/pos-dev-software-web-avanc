...
import { TipoFestaDeleteDialog } from './tipo-festa-delete-dialog';

describe('TipoFesta Management Delete Component', () => {
  let comp: TipoFestaDeleteDialog;
  let fixture: ComponentFixture<TipoFestaDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TipoFestaDeleteDialog);
