...
import static com.anderson.jhipsterapp1.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
import static org.assertj.core.api.Assertions.assertThat;

import com.anderson.jhipsterapp1.Jhipsterapp1App;
import com.anderson.jhipsterapp1.config.Constants;
import com.anderson.jhipsterapp1.config.audit.AuditEventConverter;
import com.anderson.jhipsterapp1.domain.PersistentAuditEvent;
...
public class CustomAuditEventRepositoryIT {
  ...
  public void addAuditEvent() {
    ...
    assertThat(persistentAuditEvent.getAuditEventDate().truncatedTo(ChronoUnit.MILLIS)).isEqualTo(
      event.getTimestamp().truncatedTo(ChronoUnit.MILLIS)
    );
  }
