...
public class ItemPedidoResourceIT {
  ...
  public void createItemPedido() throws Exception {
    ...
    restItemPedidoMockMvc
      .perform(post("/api/item-pedidos").contentType(TestUtil.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(itemPedidoDTO)))
  ...
  public void getAllItemPedidos() throws Exception {
    ...
    restItemPedidoMockMvc
      .perform(get("/api/item-pedidos?sort=id,desc"))
  ...
  public void getItemPedido() throws Exception {
    ...
    // Get the itemPedido
    restItemPedidoMockMvc
      .perform(get("/api/item-pedidos/{id}", itemPedido.getId()))
      .andExpect(status().isOk())
      .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
  ...
  public void getNonExistingItemPedido() throws Exception {
    // Get the itemPedido
    restItemPedidoMockMvc.perform(get("/api/item-pedidos/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
  }
  ...
  public void updateItemPedido() throws Exception {
    ...
    restItemPedidoMockMvc
      .perform(put("/api/item-pedidos").contentType(TestUtil.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(itemPedidoDTO)))
      .andExpect(status().isOk());
  ...
  public void deleteItemPedido() throws Exception {
    ...
    restItemPedidoMockMvc
      .perform(delete("/api/item-pedidos/{id}", itemPedido.getId()).accept(TestUtil.APPLICATION_JSON))
