...
describe('ItemPedido Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'item-pedido', component: ItemPedidoComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.itemPedidos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
