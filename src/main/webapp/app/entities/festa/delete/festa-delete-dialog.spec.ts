...
import { FestaDeleteDialog } from './festa-delete-dialog';

describe('Festa Management Delete Component', () => {
  let comp: FestaDeleteDialog;
  let fixture: ComponentFixture<FestaDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(FestaDeleteDialog);
