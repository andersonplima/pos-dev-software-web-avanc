...
import com.anderson.jhipsterapp1.service.mapper.UserMapper;
...
public class UserResourceIT {
  ...
  public void createUser() throws Exception {
    ...
    restUserMockMvc
      .perform(post("/api/users").contentType(TestUtil.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(managedUserVM)))
  ...
  public void updateUser() throws Exception {
    ...
    restUserMockMvc
      .perform(put("/api/users").contentType(TestUtil.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(managedUserVM)))
      .andExpect(status().isOk());
  ...
  public void deleteUser() throws Exception {
    ...
    // Delete the user
    restUserMockMvc
      .perform(delete("/api/users/{login}", user.getLogin()).accept(TestUtil.APPLICATION_JSON))
  ...
  public void getAllAuthorities() throws Exception {
    restUserMockMvc
      .perform(get("/api/users/authorities").accept(TestUtil.APPLICATION_JSON).contentType(TestUtil.APPLICATION_JSON))
      .andExpect(status().isOk())
      .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
