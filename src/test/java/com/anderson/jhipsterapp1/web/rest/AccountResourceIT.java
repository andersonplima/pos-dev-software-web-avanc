...
import static com.anderson.jhipsterapp1.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import com.anderson.jhipsterapp1.repository.AuthorityRepository;
...
public class AccountResourceIT {
  ...
  public void testRegisterValid() throws Exception {
    ...
    restAccountMockMvc
      .perform(post("/api/register").contentType(TestUtil.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(validUser)))
  ...
  public void testRegisterInvalidLogin() throws Exception {
    ...
    restAccountMockMvc
      .perform(post("/api/register").contentType(TestUtil.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(invalidUser)))
  ...
  public void testRegisterDuplicateLogin() throws Exception {
    ...
    // First user
    restAccountMockMvc
      .perform(post("/api/register").contentType(TestUtil.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(firstUser)))
      .andExpect(status().isCreated());

    // Second (non activated) user
    restAccountMockMvc
      .perform(post("/api/register").contentType(TestUtil.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(secondUser)))
      .andExpect(status().isCreated());
  ...
  public void testRegisterDuplicateEmail() throws Exception {
    ...
    restAccountMockMvc
      .perform(
        post("/api/register").contentType(TestUtil.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(userWithUpperCaseEmail))
      )
      .andExpect(status().isCreated());
  ...
  public void testSaveAccount() throws Exception {
    ...
    restAccountMockMvc
      .perform(post("/api/account").contentType(TestUtil.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(userDTO)))
      .andExpect(status().isOk());
