...
export class Cliente implements OnInit {
  ...
  constructor() {
    ...
    effect(() => {
      this.clientes.set(this.fillComponentAttributesFromResponseBody([...this.clienteService.clientes()]));
    });
  }
  ...
  protected fillComponentAttributesFromResponseBody(data: ICliente[]): ICliente[] {
    return data;
  }
